...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.15/24 | 172.16.100.1 |
...
| --------- | --------------- | ------------ | --------- |
| HQ_FLOOR1_RACK | Vlan4094 | 192.168.0.0 | Port-Channel47 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_SPINE1_Ethernet2 | *trunk | *10-12,99 | *- | *- | 1 |
| Ethernet2 | L2_SPINE2_Ethernet2 | *trunk | *10-12,99 | *- | *- | 1 |
| Ethernet3 | SERVER_HostB_Eth1 | access | 10 | - | - | - |
